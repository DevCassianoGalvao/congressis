/* ============================================================
   CONGRESSIS — Preview (static / Vercel)
   Sem backend: valida e redireciona direto ao Kiwify.
   ============================================================ */
(function(){
  "use strict";
  ...
  function cnpjOk(v){
    ...
    function calc(n, len){
      ...
      var s = 0; for(var i=0;i<len;i++) s += +n[i]*w[i];
  ...
  document.getElementById('regForm').addEventListener('submit', function(e){
    ...
    if(cep && cep.replace(/\D/g,'').length !== 8) { setErr('f-cep', true); ok = false; } else setErr('f-cep', false);
    ...
    setTimeout(function(){
      window.location.href = buildCheckoutUrl(nome, email, celular, cpf);
    }, 1200);
  });
